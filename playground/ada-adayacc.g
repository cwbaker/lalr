...
ABORT_TOKEN : "[Aa][Bb][Oo][Rr][Tt]" ;
ABS_TOKEN : "[Aa][Bb][Ss]" ;
ACCEPT_TOKEN : "[Aa][Cc][Cc][Ee][Pp][Tt]" ;
ACCESS_TOKEN : "[Aa][Cc][Cc][Ee][Ss][Ss]" ;
ALL_TOKEN : "[Aa][Ll][Ll]" ;
AND_TOKEN : "[Aa][Nn][Dd]" ;
ARRAY_TOKEN : "[Aa][Rr][Rr][Aa][Yy]" ;
AT_TOKEN : "[Aa][Tt]" ;
BEGIN_TOKEN : "[Bb][Ee][Gg][Ii][Nn]" ;
BODY_TOKEN : "[Bb][Oo][Dd][Yy]" ;
CASE_TOKEN : "[Cc][Aa][Ss][Ee]" ;
CONSTANT_TOKEN : "[Cc][Oo][Nn][Ss][Tt][Aa][Nn][Tt]" ;
DECLARE_TOKEN : "[Dd][Ee][Cc][Ll][Aa][Rr][Ee]" ;
DELAY_TOKEN : "[Dd][Ee][Ll][Aa][Yy]" ;
DELTA_TOKEN : "[Dd][Ee][Ll][Tt][Aa]" ;
DIGITS_TOKEN : "[Dd][Ii][Gg][Ii][Tt][Ss]" ;
DO_TOKEN : "[Dd][Oo]" ;
ELSE_TOKEN : "[Ee][Ll][Ss][Ee]" ;
ELSIF_TOKEN : "[Ee][Ll][Ss][Ii][Ff]" ;
END_TOKEN : "[Ee][Nn][Dd]" ;
ENTRY_TOKEN : "[Ee][Nn][Tt][Rr][Yy]" ;
EXCEPTION_TOKEN : "[Ee][Xx][Cc][Ee][Pp][Tt][Ii][Oo][Nn]" ;
EXIT_TOKEN : "[Ee][Xx][Ii][Tt]" ;
FOR_TOKEN : "[Ff][Oo][Rr]" ;
FUNCTION_TOKEN : "[Ff][Uu][Nn][Cc][Tt][Ii][Oo][Nn]" ;
GENERIC_TOKEN : "[Gg][Ee][Nn][Ee][Rr][Ii][Cc]" ;
GOTO_TOKEN : "[Gg][Oo][Tt][Oo]" ;
IF_TOKEN : "[Ii][Ff]" ;
IN_TOKEN : "[Ii][Nn]" ;
IS_TOKEN : "[Ii][Ss]" ;
LIMITED_TOKEN : "[Ll][Ii][Mm][Ii][Tt][Ee][Dd]" ;
...
OF_TOKEN : "[Oo][Ff]" ;
OR_TOKEN : "[Oo][Rr]" ;
OTHERS_TOKEN : "[Oo][Tt][Hh][Ee][Rr][Ss]" ;
OUT_TOKEN : "[Oo][Uu][Tt]" ;
PACKAGE_TOKEN : "[Pp][Aa][Cc][Kk][Aa][Gg][Ee]" ;
PRAGMA_TOKEN : "[Pp][Rr][Aa][Gg][Mm][Aa]" ;
PRIVATE_TOKEN : "[Pp][Rr][Ii][Vv][Aa][Tt][Ee]" ;
PROCEDURE_TOKEN : "[Pp][Rr][Oo][Cc][Ee][Dd][Uu][Rr][Ee]" ;
RAISE_TOKEN : "[Rr][Aa][Ii][Ss][Ee]" ;
RANGE_TOKEN : "[Rr][Aa][Nn][Gg][Ee]" ;
RECORD_TOKEN : "[Rr][Ee][Cc][Oo][Rr][Dd]" ;
REM_TOKEN : "[Rr][Ee][Mm]" ;
RENAMES_TOKEN : "[Rr][Ee][Nn][Aa][Mm][Ee][Ss]" ;
RETURN_TOKEN : "[Rr][Ee][Tt][Uu][Rr][Nn]" ;
REVERSE_TOKEN : "[Rr][Ee][Vv][Ee][Rr][Ss][Ee]" ;
SELECT_TOKEN : "[Ss][Ee][Ll][Ee][Cc][Tt]" ;
SEPARATE_TOKEN : "[Ss][Ee][Pp][Aa][Rr][Aa][Tt][Ee]" ;
SUBTYPE_TOKEN : "[Ss][Uu][Bb][Tt][Yy][Pp][Ee]" ;
TASK_TOKEN : "[Tt][Aa][Ss][Kk]" ;
TERMINATE_TOKEN : "[Tt][Ee][Rr][Mm][Ii][Nn][Aa][Tt][Ee]" ;
THEN_TOKEN : "[Tt][Hh][Ee][Nn]" ;
TYPE_TOKEN : "[Tt][Yy][Pp][Ee]" ;
USE_TOKEN : "[Uu][Ss][Ee]" ;
WHEN_TOKEN : "[Ww][Hh][Ee][Nn]" ;
WHILE_TOKEN : "[Ww][Hh][Ii][Ll][Ee]" ;
WITH_TOKEN : "[Ww][Ii][Tt][Hh]" ;
XOR_TOKEN : "[Xx][Oo][Rr]" ;
