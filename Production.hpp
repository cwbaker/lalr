...
class Production
{
    ...
    const GrammarAction* action_; ///< The action taken when this Production is reduced or null if there is no action.
    ...
    public:
        Production( int index, Symbol* symbol, int line, const GrammarAction* action );
