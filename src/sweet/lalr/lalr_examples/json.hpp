...
{
    { 34, 35, &json_lexer_state_machine_state_9, NULL }, 
    { 39, 40, &json_lexer_state_machine_state_9, NULL }, 
    ...
    { 110, 111, &json_lexer_state_machine_state_5, NULL }, 
...
{
    { 117, 118, &json_lexer_state_machine_state_6, NULL }, 
    { 0, 0, NULL, NULL }
};
...
{
    { 108, 109, &json_lexer_state_machine_state_7, NULL }, 
    { 0, 0, NULL, NULL }
};
...
const sweet::parser::LexerState json_lexer_state_machine_state_6 =
{
    ...
    json_lexer_state_machine_state_6_transitions + 1
};


const sweet::parser::LexerTransition json_lexer_state_machine_state_7_transitions[] =
{
    { 108, 109, &json_lexer_state_machine_state_8, NULL }, 
    { 0, 0, NULL, NULL }
};
...
const sweet::parser::LexerState json_lexer_state_machine_state_8 =
{
    ...
    json_lexer_state_machine_state_8_transitions + 0
};


const sweet::parser::LexerTransition json_lexer_state_machine_state_9_transitions[] =
{
    { 0, 2147483647, &json_lexer_state_machine_state_10, &json_lexer_actions[0] }, 
    { 0, 0, NULL, NULL }
};
...
3:
left_curly_brace_terminal element . right_curly_brace_terminal ; dot_end
shift to 4 on right_curly_brace_terminal ; 
...
/*
5:
. string colon_terminal left_curly_brace_terminal contents right_curly_brace_terminal ; right_curly_brace_terminal, comma_terminal
string colon_terminal left_curly_brace_terminal . contents right_curly_brace_terminal ; right_curly_brace_terminal, comma_terminal
...
. string colon_terminal value ; right_curly_brace_terminal, comma_terminal
...
string colon_terminal . left_curly_brace_terminal contents right_curly_brace_terminal ; right_curly_brace_terminal, comma_terminal
string colon_terminal . value ; right_curly_brace_terminal, comma_terminal
. null ; right_curly_brace_terminal, comma_terminal
. boolean ; right_curly_brace_terminal, comma_terminal
. integer ; right_curly_brace_terminal, comma_terminal
. real ; right_curly_brace_terminal, comma_terminal
. string ; right_curly_brace_terminal, comma_terminal
